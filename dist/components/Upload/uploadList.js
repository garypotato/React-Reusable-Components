...
export var UploadList = function (props) {
    ...
    return (React.createElement("ul", { className: "garyc-upload-list" }, fileList.map(function (item) {
        return (React.createElement("li", { className: "garyc-upload-list-item", key: item.uid },
